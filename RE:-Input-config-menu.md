```C
//----- (00406CC0) --------------------------------------------------------
char __usercall sub_406CC0@<al>(char *a1@<ebx>, int a2, int a3, int a4, char *a5, int a6) {
  char *v6; // esi
  signed int v7; // edi
  _DWORD *v8; // eax
  const char *v9; // eax
...
LABEL_45:
        if ( !sub_4078A0((char *)a3, a5, a6, 0, 0, v12) )
          (*(void (__cdecl **)(char *, char *, signed int))(dword_ECC420 + 24))(
            aElfcontrolRepl,
            aDDevelQa5PcGno_4,
            1784);
        if ( a3 == 2 )
...
LABEL_78:
    ...
    if ( v63 >= 0 && dword_4D6B40 )
    {
      ...
      if ( v39 >= 0 )
      {
        ...
        if ( !_strcmpi(v42, v43) || (v44 = sub_421360(aMondotextH0020), !_strcmpi(v42, v44)) )
        {
