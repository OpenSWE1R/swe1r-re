  ...
  if ( !(v29 & 0x2000) ) {
    ...
    do
    {
      ...
      do
      {
        ...
        if ( LOBYTE(v50) & 8 )
        {
          ...
          {
            v44 = (signed __int64)((double)(255 - v44) * flt_4C52A0[a2] + (double)v114);
            v45 = (signed __int64)((double)(128 - v45) * flt_4C52A0[a2] + (double)v118);
            v46 = (signed __int64)((double)-v46 * flt_4C52A0[a2] + (double)v117);
            v48 = v115;
    ...
    if ( *(float *)(v92 + 536) >= 20.0 )
    {
      if ( *(float *)(v92 + 536) < 50.0 )
      {
        ...
        if ( (unsigned int)&unk_800000 & *(_DWORD *)(v92 + 96) )
        {
          ...
          sub_450530(54, (signed __int64)(v109 - -48.0), v60, v61, v62, v63, (int)v64);
        }
        if ( dword_50C5F0 )
          v65 = 223.25;
        else
    ...
    else
    {
      ...
      if ( !v121 && (unsigned int)&unk_800000 & *(_DWORD *)(v92 + 96) )
      {
        ...
        sub_450530(54, (signed __int64)(v109 - -48.0), -1, -128, 0, v55, (int)v56);
      }
      v119 = -1;
      v126 = -1;
      v120 = -128;
    ...
    if ( v94 )
    {
      ...
      sub_450530(
        54,
        (signed __int64)(v106 - -48.0),
        (signed __int64)(v66 - -128.0),
        (signed __int64)v66,
        (signed __int64)v66,
        (signed __int64)(v66 - -128.0),
        (int)v67);
    ...
    if ( *(_DWORD *)(v92 + 96) & 0x400 )
    {
      ...
      sub_450530(54, (signed __int64)(v106 - -48.0), v88, -128, v89, v90, (int)v91);
    }
    else
    {
      flt_50CA70[a2] = 0.0;
...
LABEL_197:
  ...
  return sub_428740(
           ...
           v122,
           v124,
           (signed __int64)((double)v127 * *(float *)&dword_50CA60[a2] * *(float *)&dword_50CA60[a2]));
}
```